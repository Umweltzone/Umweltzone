...
public interface Preferences {
    ...
    String KEY_DATA_PRIVACY_MODAL_WAS_SHOWN =
            BuildConfig.APPLICATION_ID + ".KEY_DATA_PRIVACY_MODAL_WAS_SHOWN";

    String KEY_MY_LOCATION_PERMISSION_IS_PERMANENTLY_DECLINED =
            BuildConfig.APPLICATION_ID + ".KEY_MY_LOCATION_PERMISSION_IS_PERMANENTLY_DECLINED";
